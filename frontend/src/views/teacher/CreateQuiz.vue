...
<!--      </select>-->
    ...
    <div id="live-quiz-container">
      <label for="live">Live Quiz</label>
      <input v-model="quiz.isLiveQuiz" type="checkbox" id="live">
      <div class="help-tip">
        <p>If you choose live quiz, the quiz will not be visible for students. Only you will be able to start it as a live quiz, where all students can join and compete simultaneously.</p>
      </div>
    </div>
    ...
    if(!this.creating) {
      api.get('/quizdetails/' + this.$route.params.id)
        ...
        .then(json => {
          ...
          this.quiz.isLiveQuiz = json.isLiveQuiz;
